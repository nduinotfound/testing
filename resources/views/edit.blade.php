...
<div class="container mt-5">
    ...
    <form action="{{ route('barang.update', $barang->id) }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="kondisi" name="kondisi" value="{{ old('kondisi', $barang->kondisi) }}" required>
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="date" class="form-control" id="tanggal_masuk" name="tanggal_masuk" value="{{ old('tanggal_masuk', $barang->tanggal_masuk) }}" required>
        </div>
